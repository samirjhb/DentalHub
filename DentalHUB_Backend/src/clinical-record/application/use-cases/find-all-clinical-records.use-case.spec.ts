import { FindAllClinicalRecordsUseCase } from './find-all-clinical-records.use-case';
import { InMemoryClinicalRecordRepository } from '../testing/in-memory-clinical-record.repository';
import { CreateClinicalRecordDto } from '../dto/create-clinical-record.dto';

describe('FindAllClinicalRecordsUseCase', () => {
  let repository: InMemoryClinicalRecordRepository;
  let useCase: FindAllClinicalRecordsUseCase;

  beforeEach(async () => {
    repository = new InMemoryClinicalRecordRepository();
    useCase = new FindAllClinicalRecordsUseCase(repository);
